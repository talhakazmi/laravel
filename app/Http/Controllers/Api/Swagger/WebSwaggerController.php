...
class WebSwaggerController extends SwaggerController
{
    /**
    ...
    {
        $extension = 'json';
        $targetFile = config('l5-swagger.paths.docs_yaml', 'api-docs.yaml');
        if (! is_null($file)) {
            $targetFile = $file;
    ...
    public function api()
    {
        ...
        $response = Response::make(
            view('l5-swagger::index', [
                ...
                'urlToDocs' => route('l5-swagger.docs', config('l5-swagger.paths._docs_yaml', 'portal-api-docs.yaml')),
